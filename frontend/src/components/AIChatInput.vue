      ...
      <Transition name="tool-sheet">
        <div v-if="showToolSheet" class="tool-sheet">
          ...
          <div class="tool-sheet-grid">
            ...
            <button class="tool-option" @click="triggerFileUpload('.pdf,.doc,.docx,.txt')">
            ...
            <button class="tool-option">
              <div class="tool-icon notebooks"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg></div>
              <span>Notebooks</span>
            </button>
          </div>
          <div class="tool-sheet-divider"></div>
          <div class="tool-sheet-tools">
            <span class="tool-sheet-label">Tools</span>
            <div class="tool-sheet-grid">
              <button class="tool-option">Images</button>
              <button class="tool-option">Videos</button>
              <button class="tool-option">Music</button>
              <button class="tool-option">Canvas</button>
              <button class="tool-option">Deep Research</button>
              <button class="tool-option">Guided Learning</button>
            </div>
          </div>
        </div>
      </Transition>
