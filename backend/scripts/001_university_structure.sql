...
-- 0. Fix existing NOT NULL constraints (table may already exist with stricter schema)
-- Use DO blocks so each ALTER runs independently without failing the batch
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN dean_id DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN established_date DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN description DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN is_active DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN created_at DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.faculties ALTER COLUMN updated_at DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.departments ALTER COLUMN hod_id DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.departments ALTER COLUMN description DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.departments ALTER COLUMN faculty_id DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
...
-- 8. ENHANCE USERS TABLE (safe ADD COLUMN - wrapped in DO blocks for safety)
DO $$ BEGIN ALTER TABLE public.users ADD COLUMN IF NOT EXISTS programme_id UUID REFERENCES public.programmes(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.users ADD COLUMN IF NOT EXISTS department_id UUID REFERENCES public.departments(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.users ADD COLUMN IF NOT EXISTS expected_graduation_date DATE; EXCEPTION WHEN OTHERS THEN NULL; END $$;
...
-- 13. Seed MCU faculties (only if table is empty - wrapped in DO for safety)
DO $$ BEGIN
...
-- 14. Seed departments (only if departments table is empty - wrapped in DO for safety)
DO $$ BEGIN
