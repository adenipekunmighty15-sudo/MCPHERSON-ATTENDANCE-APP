...
export async function down(db) {
  ...
  await db.query(`DROP TABLE IF EXISTS public.group_shared_materials`)
  await db.query(`DROP TABLE IF EXISTS public.study_group_members`)
  await db.query(`DROP TABLE IF EXISTS public.study_groups`)
  await db.query(`DROP TABLE IF EXISTS public.podcasts`)
